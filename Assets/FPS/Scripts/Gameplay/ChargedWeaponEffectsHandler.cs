...
namespace Unity.FPS.Gameplay
{
    ...
    public class ChargedWeaponEffectsHandler : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            ParticleSystem.VelocityOverLifetimeModule velocityOverTimeModule = m_DiskOrbitParticle.velocityOverLifetime;
            velocityOverTimeModule.orbitalY = OrbitY.GetValueFromRatio(m_ChargeRatio);
