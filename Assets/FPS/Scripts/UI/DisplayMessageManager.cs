...
namespace Unity.FPS.UI
{
    public class DisplayMessageManager : MonoBehaviour
    {
        ...
        {
            if (MessagePrefab == null || DisplayMessageRect == null)
                return;
        ...
        void Update()
        {
            ...
            {
                if (message.notification != null && Time.time - message.timestamp > message.delay)
                {
        ...
        {
            if (notification == null || DisplayMessageRect == null)
                return;
